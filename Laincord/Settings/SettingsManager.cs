...
namespace Laincord.Settings
{
    ...
    public class SettingsManager : ViewModelBase
    {
        ...
        private static string SettingsFilePath
        {
            get
            {
                ...
                string applicationLocalPath = Path.Combine(
                    ...
                    $"{Assembly.GetEntryAssembly()!.GetName().Name}.json");        // \Laincord.json

                // User-local configuration. Since Laincord since version 0.2 can be
                ...
                string userPath = Path.Combine(
                    ...
                    Assembly.GetEntryAssembly()!.GetName().Name,                          // \Laincord
                ...
                // Laincord 0.2 installer manages migration of 0.1-era configuration.
        ...
        [Settings("Appearance", "Show the Laincord Discord server link button on the home page")]
        ...
        [Settings("Appearance", "Show the Laincord link on the chat window")]

        public bool DisplayLaincordAttribution { get; set; } = true;
