...
using OpusDotNet;
using Lainvoice.Players;
using Lainvoice.Decoders;
using Lainvoice.Crypts;
using Lainvoice.Logging;
using Lainvoice.Recorders;
using Lainvoice.Encoders;
using Lainvoice.Timestamp;
using static System.Runtime.InteropServices.JavaScript.JSType;

namespace Lainvoice.Clients
{
    public class VoiceSocket
    {
        ...
        {
            var decryptors = typeof(BaseCrypt).Assembly.GetTypes().Where(x => x.Namespace == "Lainvoice.Crypts" && x.IsSubclassOf(typeof(BaseCrypt)) && _availableEncryptionModes.Contains((string)x.GetProperty("Name")!.GetValue(null)!));
