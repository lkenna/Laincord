    ...
    public sealed class WpfBootstrap
    {
        ...
        public void Init()
        {
            ...
            if (Application.Current == null)
            {
                ...
                var app = new Laincord.App();
                app.InitializeComponent(); // merges App.xaml dictionaries
            }
            else if (Application.Current is Laincord.App existingApp)
            {
            ...
            {
                // Another Application already exists; we can't create Laincord.App now.
                ...
                // rd.Add(new ResourceDictionary { Source = new Uri("pack://application:,,,/Laincord;component/Resources/WindowStyles.xaml") });
                // rd.Add(new ResourceDictionary { Source = new Uri("pack://application:,,,/Laincord;component/Resources/Theme.xaml") });
            }
